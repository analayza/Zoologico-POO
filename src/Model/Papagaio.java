...
public class Papagaio extends Animal {
   ...
   public Papagaio(
    ...
    Papagaio(String nome, String especie, String tipoDeAlimentacao, int idade, float tempoDeVidaEstimado, boolean temRabo, boolean temChifre, boolean temPelos, boolean temEscamas, int quantidadeDePatas) {
